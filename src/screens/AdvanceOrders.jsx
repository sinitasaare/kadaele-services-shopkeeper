  ...
  return (
    <div className="d-screen">
      ...
      <div className="d-header">
        <input type="text" className="d-search" placeholder="Search advance order…"
      ...
      <div className="d-grid">
        {filteredDebtors.length === 0 ? (
          <div className="d-empty">
            {searchTerm ? 'No advance orders match your search.' : 'No advance orders yet. Create a new customer advance order from the Cash Record section.'}
          </div>
        ) : (
